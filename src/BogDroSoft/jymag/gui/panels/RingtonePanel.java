			...
			try
			{
				...
				for ( int i = 0; i < selectedRows.length; i++ )
				{
						...
						new Runnable ()
					{
						...
						{
							return "RingtonePanel.downloadRingButdownloadButActionPerformed.Runnable";	// NOI18N
						}
			...
			try
			{
				...
				for ( int i = 0; i < selectedRows.length; i++ )
				{
						...
						new Runnable ()
					{
						...
						public String toString ()
						{
							return "RingtonePanel.deleteRingButdeleteButActionPerformed.Runnable";	// NOI18N
						}
					}, this, false, false, false);
				}
			}
