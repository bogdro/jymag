			...
			try
			{
				...
				for ( int i = 0; i < selectedRows.length; i++ )
				{
						...
						new Runnable ()
					{
						...
						{
							return "AddrBookPanel.downloadAddrButdownloadButActionPerformed.Runnable";	// NOI18N
						}
			...
			try
			{
				...
				for ( int i = 0; i < selectedRows.length; i++ )
				{
						...
						new Runnable ()
					{
						...
						public String toString ()
						{
							return "AddrBookPanel.deleteAddrButdeleteButActionPerformed.Runnable";	// NOI18N
						}
					}, this, false, false, false);
				}
			}
