...
public class PhotoPanel extends javax.swing.JPanel implements JYMAGTab
{
	...
	@SuppressWarnings({"unchecked", "rawtypes"})
        ...
        private void initComponents()
        {
                ...
                java.util.ResourceBundle bundle1 = java.util.ResourceBundle.getBundle("bogdrosoft/jymag/i18n/PhotoPanel"); // NOI18N
                downloadPhotoBut.getAccessibleContext().setAccessibleName(bundle1.getString("down_but_name")); // NOI18N
                downloadPhotoBut.getAccessibleContext().setAccessibleDescription(bundle1.getString("down_but_desc")); // NOI18N
                uploadPhotoBut.getAccessibleContext().setAccessibleName(bundle1.getString("upload_but_name")); // NOI18N
                uploadPhotoBut.getAccessibleContext().setAccessibleDescription(bundle1.getString("upload_but_desc")); // NOI18N
                deletePhotoBut.getAccessibleContext().setAccessibleName(bundle1.getString("delbut_name")); // NOI18N
                deletePhotoBut.getAccessibleContext().setAccessibleDescription(bundle1.getString("delbut_desc")); // NOI18N
                getPhotoListBut.getAccessibleContext().setAccessibleName(bundle1.getString("get_list_but_name")); // NOI18N
                getPhotoListBut.getAccessibleContext().setAccessibleDescription(bundle1.getString("get_list_but_desc")); // NOI18N
